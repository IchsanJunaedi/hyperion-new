    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-base font-bold text-ui-text">Tambah Transaksi</h3>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <p className="text-xs text-ui-text-2 mb-2">Tipe</p>
                ...
                <button
                  ...
                  className={`flex-1 py-2 text-sm font-medium transition-colors ${
                    type === t
                      ...
                      : "bg-ui-bg text-ui-text-2 hover:bg-ui-hover"
                  }`}
                >
          ...
          <div>
            <label className="block text-xs text-ui-text-2 mb-1">Jumlah (Rp)</label>
            <NumberInput
              name="amount"
              min={1}
              required
              placeholder="500000"
              className="focus:border-ui-text"
            />
          </div>

          <div>
            <label className="block text-xs text-ui-text-2 mb-1">Kategori</label>
            <select
              key={type}
              name="category"
              required
          ...
          <div>
            <label className="block text-xs text-ui-text-2 mb-1">Tanggal</label>
            <input
              name="date"
              type="date"
              required
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              type="button"
              onClick={onClose}
              className="h-9 rounded-md border border-ui-border px-4 text-sm text-ui-text-2 hover:bg-ui-hover"
            >
              Batal
            </button>
            <button
