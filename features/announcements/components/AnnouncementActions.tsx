  ...
  return (
    <div className="flex flex-wrap gap-2">
      <Link
        ...
        className="inline-flex h-9 items-center gap-2 rounded-md border border-white/10 px-3 text-xs font-medium text-ui-text transition hover:bg-white/5 hover:text-ui-text"
      >
      ...
      <button
        ...
        className="inline-flex h-9 items-center gap-2 rounded-md border border-white/10 px-3 text-xs font-medium text-ui-text transition hover:bg-white/5 hover:text-ui-text disabled:opacity-50"
      >
        {pinPending ? (
      ...
      <button
        ...
        className={`inline-flex h-9 items-center gap-2 rounded-md border px-3 text-xs font-medium transition disabled:opacity-50 ${
          confirmDelete
            ...
            : "border-white/10 text-ui-text hover:bg-white/5 hover:text-ui-text"
        }`}
      >
        {deletePending ? (
          <Loader2 className="h-3.5 w-3.5 animate-spin" />
