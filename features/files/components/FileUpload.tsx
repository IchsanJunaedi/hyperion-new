  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <label className="inline-flex h-9 cursor-pointer items-center gap-2 rounded-md border border-ui-border px-3 text-xs font-medium text-ui-text transition hover:bg-ui-elevated hover:text-ui-text">
          {uploading ? (
        ...
        {fileName && !uploading && (
          <div className="flex items-center gap-1.5 rounded-md bg-ui-elevated px-2 py-1 text-xs text-ui-text-2">
