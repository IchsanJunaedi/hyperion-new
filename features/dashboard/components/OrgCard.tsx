      ...
      <div className="flex items-center justify-between">
        ...
        {!editing && (
          <div className="flex gap-1">
            <button onClick={() => setEditing(true)} className="p-1.5 text-white/40 hover:bg-white/10 hover:text-white rounded-md" title="Edit nama">
      ...
      <div className="space-y-1.5">
        ...
        {showAddDiv ? (
          <div className="flex items-center gap-2 mt-2">
            ...
            <button onClick={() => setShowAddDiv(false)} className="p-1 text-white/40 hover:text-white">
              <X className="h-3.5 w-3.5" />
            </button>
          </div>
        ) : (
