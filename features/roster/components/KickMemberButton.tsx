  ...
  return (
    <>
      <button
        ...
        className="inline-flex h-7 items-center gap-1.5 rounded-md border border-ui-border px-2.5 text-xs text-ui-text-2 transition hover:border-red-500/30 hover:text-red-400"
      >
