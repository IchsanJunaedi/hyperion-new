...
const SEO_FIELDS: SettingsField[] = [
  ...
  { key: "seo_gallery_title", label: "Gallery/Achievement — Title", placeholder: "Achievement — Hyperion Team" },
  { key: "seo_gallery_description", label: "Gallery/Achievement — Description", placeholder: "Prestasi dan pencapaian Hyperion Team di berbagai turnamen nasional dan regional.", multiline: true },
  { key: "seo_news_title", label: "News — Title", placeholder: "News — Hyperion Team" },
  { key: "seo_news_description", label: "News — Description", placeholder: "Berita dan update terbaru dari Hyperion Team.", multiline: true },
  { key: "seo_schedule_title", label: "Schedule — Title", placeholder: "Schedule — Hyperion Team" },
  { key: "seo_schedule_description", label: "Schedule — Description", placeholder: "Jadwal turnamen mendatang Hyperion Team.", multiline: true },
  { key: "seo_sponsors_title", label: "Sponsors — Title", placeholder: "Sponsors — Hyperion Team" },
  { key: "seo_sponsors_description", label: "Sponsors — Description", placeholder: "Brand dan sponsor yang mendukung Hyperion Team.", multiline: true },
