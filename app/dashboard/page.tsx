...
function ManagerAssignments({
  ...
  members: Array<{ id: string; user_id: string; organization_id: string; role: string; is_active: boolean }>;
  profiles: Array<{ id: string; full_name: string | null; username: string | null; display_name: string | null }>;
      ...
      <table className="w-full text-sm">
        ...
        <tbody className="divide-y divide-white/5">
          {managers.map((m) => {
            ...
            // Find divisions for this manager's org
            const orgDivisions = allDivisions.filter((d) => d.organization_id === m.organization_id);
            return (
